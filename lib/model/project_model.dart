...
List<Project> projectList = [
  ...
  Project(
      ...
      '''Role: Lead Flutter Developer | Full App Development (Built from Scratch)
        Naukari Alert is a dedicated career and job-alert mobile application designed to help users discover the latest job opportunities, receive personalized notifications, and streamline their job search process across various sectors in India.
        My Contribution:
